...
public class Order implements Serializable {
	...
	@OneToOne(mappedBy = "order", cascade = CascadeType.ALL) // mapeando a relação um para um do pagamento com o pedido falando que o pagamento vai ter o mesmo id do pedido.
